...
export default function Login() {
  ...
  const validateForm = () => {
    ...
    if (!formData.email) {
      ...
      // Only validate email format for signup, not for login (can be username)
      ...
      <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full p-3 border-4 ${errors.confirmPassword ? 'border-red-500' : 'border-black'} focus:ring-0 focus:outline-none bg-white font-medium`}
                  placeholder="••••••••"
                />
                {errors.confirmPassword && (
                  <p className="text-red-600 text-xs font-bold mt-1">{errors.confirmPassword}</p>
                )}
              </div>
            )}
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-purple-100 text-black font-bold">OR</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full bg-white text-black py-3 font-bold border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all flex items-center justify-center gap-2"
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-black font-medium">
            ...
            <a href="/about" className="text-purple-600 font-bold hover:underline">Terms of Service</a>
            {" "}and{" "}
            <a href="/about" className="text-purple-600 font-bold hover:underline">Privacy Policy</a>
          </p>
        </div>
      </div>
    </div>
